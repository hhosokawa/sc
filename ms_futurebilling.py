...
output = 'o\\future billing.csv'
missing_enrol_output = 'C:/Portable Python 2.7/App/Scripts/o/missing_enrol.txt'
year_end = date(2015, 1, 1)

input0 = 'i\\future_billing\\future billing - explore ms.csv'
input1 = 'i\\future_billing\\future billing.csv'   # Automatically Generated 90% Renewal
input2 = 'i\\future_billing\\contract repo.csv'    # Reminder: delete Duplicates
enrollhistory = csv_dic('i\\future_billing\\enrol history.csv', 6)
indirectpo = csv_dic('i\\future_billing\\po itemnumber - sell price.csv', '2b') # Left 9, Space
...
def header_add(header):
    newfields = ['Custom Category A', 'Custom Category B', 'GP', 'Rep',
                 ...
                 'Scheduled Bill Year', 'Purchase Order Date', 
                 'Last License Coverage Date']
